export declare function createViemPublicClient(): {
    account: undefined;
    batch?: {
    ...
    simulate: <const calls extends readonly unknown[]>(args: import("viem/_types/actions/public/simulate").SimulateParameters<calls>) => Promise<import("viem/_types/actions/public/simulate").SimulateReturnType<calls>>;
...
//# sourceMappingURL=createViemPublicClient.d.ts.map